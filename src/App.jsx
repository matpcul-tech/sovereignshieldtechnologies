...
const CHIKASHA_PRODUCTS = [
  ...
  {icon:"⬡",name:"SOVEREIGN PROMPT SHIELD",sub:"Data Protection Layer",desc:"Intercepts every AI query before transmission. Detects PII, tribal enrollment data, and Chikashshanompa' terms — hashing them at the browser edge under tribal governance.",url:"https://chikashaai-promptshield12.vercel.app",color:C.goldLight,tags:["ZK Hash Layer","HIPAA Aligned","Real-time Detection","Tribal Governance","Browser Edge"],live:true},
...
const CARE_PRODUCTS = [
  {icon:"⊕",name:"CAREIQ",sub:"FQHC Community Health Intelligence",desc:"AI-powered clinical intelligence for Federally Qualified Health Centers. Eight-patient panel with risk scoring, care gap management, UDS quality measure tracking, five-year impact projections, live wearable integration, and an AI clinical assistant routed through the server-side Sovereign Prompt Shield.",url:"https://care-iq-sable.vercel.app",color:C.tealLight,tags:["Risk Stratification","Care Gap Engine","UDS Reporting","HIPAA Aligned","Shield Protected"],live:true,featured:true},
  {icon:"◉",name:"CARECIRCLE FQHC EDITION",sub:"Family Elder Care — CareIQ Connected",desc:"Family care coordination for elder households served by FQHCs. Medication schedule with tap-to-mark-taken, care task management, family coordination, AI care assistant, and CareIQ clinical integration. Free for all FQHC families.",url:"https://care-os-uo7x.vercel.app",color:C.tealLight,tags:["Medication Tracking","Care Tasks","CareIQ Built In","Shield Protected","Elder Care"],live:true},
  ...
  <footer style={{borderTop:`1px solid ${C.border}`,padding:"32px 24px",position:"relative",zIndex:1}}>
    <div style={{maxWidth:900,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}>
      ...
      <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
        ...
        {[["CareIQ","https://care-iq-sable.vercel.app"],["CareCircle FQHC","https://care-os-uo7x.vercel.app"],["EduIQ","https://eduiq.vercel.app"]].map(([label,url])=>(
