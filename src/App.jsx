...
const CARE_PRODUCTS = [
  ...
  {icon:"◈",name:"EDUIQ",sub:"Child Mental Health Early Warning",desc:"A student-centered intelligence platform connecting school, home, healthcare, and community services — with parents at the center of every decision. Identifies early warning signals across domains before a crisis develops.",url:"https://eduiq-git-claude-build-new-app-vi2mb-matpcul-7370s-projects.vercel.app",color:C.tealBright,tags:["Parent Controlled","School Connected","Mental Health AI","Shield Protected","Early Warning"],live:true},
  ...
  <footer style={{borderTop:`1px solid ${C.border}`,padding:"32px 24px",position:"relative",zIndex:1}}>
    <div style={{maxWidth:900,margin:"0 auto",display:"flex",justifyContent:"space-between",alignItems:"center",flexWrap:"wrap",gap:16}}>
      ...
      <div style={{display:"flex",gap:8,flexWrap:"wrap"}}>
        ...
        {[["CareIQ","https://care-iq-sable.vercel.app"],["CareCircle FQHC","https://care-os1.vercel.app"],["EduIQ","https://eduiq-git-claude-build-new-app-vi2mb-matpcul-7370s-projects.vercel.app"]].map(([label,url])=>(
